...
def main(input_file, input_file2, out_path, complete_exon, correspondence):
    #full_exon_list, input_content = execute_request(input_file, out_path, complete_exon, correspondence)
    ...
    #full_exon_list, input_content = execute_request(input_file2, out_path, complete_exon, correspondence)
